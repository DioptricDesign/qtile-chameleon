# Qtile-Config
A feature rich Qtile configuration. It is meant to be used with pywal and other utilities to offer a novel aesthetic experience and a utilitarian workflow. It uses pywal and feh to cycle through bacground images in `~/.local/share/backgrounds`. 
## Dependencies
